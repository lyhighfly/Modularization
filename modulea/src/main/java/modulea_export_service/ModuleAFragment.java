...
public class ModuleAFragment extends Fragment {
    ...
    public static ModuleAFragment mInstance = new ModuleAFragment();
    private String title;

    public static ModuleAFragment getInstance() {
        return mInstance;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.modulea_fragment, null);
        ...
        view.findViewById(R.id.fragment_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(view.getContext(), "Hello I`m ModuleA`s Fragment Button",
